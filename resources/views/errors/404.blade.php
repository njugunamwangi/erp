...
<x-guest-layout>
    <!-- ====== Error 404 Section Start -->
<section
   class="flex items-center justify-center min-h-screen bg-white dark:bg-dark"
   >
   <div class="container mx-auto dark:bg-blue-600">
      <div class="flex -mx-4">
         <div class="w-full px-4">
            <div
               class="relative z-10 mx-auto max-w-[570px] rounded-[20px] bg-primary px-10 py-16 text-center sm:px-16 md:py-24"
               >
               <h2
               ...
               <h4 class="mb-3 text-2xl font-semibold leading-tight text-white">
               ...
               <a
                  href="/"
                  wire:navigate
                  class="inline-block dark:text-blue-500 px-8 py-3 text-base font-semibold text-center transition bg-white border border-white rounded-lg text-primary hover:bg-opacity-90"
                  >
               Go To Home
               </a>
               <div>
                  ...
                  <span class="absolute bottom-3 right-3 z-[-1]">
                     <svg
                        width="50"
                        height="79"
                        viewBox="0 0 50 79"
