<div class="mx-auto px-4 md:container">
    <div class="mx-auto w-full border border-stroke dark:border-dark-3 bg-white dark:bg-dark-2">
        <div class="flex items-center justify-between border-b border-stroke dark:border-dark-3 py-[18px] px-5 sm:px-[30px]" >
        ...
        <div class="py-[30px] max-h-[720px] px-5 sm:px-[30px] overflow-y-auto flex-grow overscroll-contain overflow-x-hidden my-auto ">
            <div class="mb-9 space-y-6">
                <div class="flex w-full max-w-[480px]">
                    ...
                    <div>
                        ...
                        <div class="inline-block rounded-[20px] rounded-tl-none bg-[#F6F5F8] dark:bg-dark-3 py-2 px-4">
                            <p class="text-base ">
                ...
                <div class="ml-auto flex w-full max-w-[480px] justify-end">
                    <div>
                        <p
