    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <section x-data="{openDropDown: false}" class="bg-gray-2 dark:bg-dark py-[90px]">
                    <div class="mx-auto px-4 md:container ">
                        <div
                            class="shadow-1 dark:shadow-box-dark mx-auto max-w-[400px] rounded-lg bg-white dark:bg-dark-2 py-8 px-6"
                            >
                ...
                <section class="bg-gray-2 w-[900px] dark:bg-dark py-20 lg:py-[90px] grid place-items-center">

                    <livewire:chat.chat-body />
                    <!-- <p class="text-gray-700 dark:text-white ">Choose a conversation</p> -->
